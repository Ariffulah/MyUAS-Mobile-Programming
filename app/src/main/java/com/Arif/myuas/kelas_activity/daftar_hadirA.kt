package com.Arif.myuas.kelas_activity

import androidx.appcompat.app.AppCompatActivity
import android.os.Bundle
import android.util.Log
import androidx.recyclerview.widget.RecyclerView
import com.Arif.myuas.Adapter.CatatanAdapter
import com.Arif.myuas.Api.ApiRetrofit
        ...
        api.data().enqueue(object : Callback<CatatanModel> {
            override fun onResponse(call: Call<CatatanModel>, response: Response<CatatanModel>) {
                if (response.isSuccessful){
                    val listData = response.body()!!.dbmobil
